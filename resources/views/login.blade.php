...
<section class="dark:bg-gray-900">
  <div class="flex items-center mx-auto md:h-screen p-5 lg:py-0 justify-center">
      <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 mx-5 md:mx-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div class="">
          ...
          <div class="p-6 space-y-4 md:space-y-4 sm:p-8">
              ...
              <form class="space-y-4 md:space-y-6" action="{{ route("login.submit") }}" method="POST">
                  ...
                  <div class="flex items-center justify-between">
                      ...
                      <a href="#" class="text-sm font-medium text-blue-600 hover:underline dark:text-blue-500">Recuperar Contraseña</a>
                  </div>
