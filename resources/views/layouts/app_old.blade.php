...
<nav class="bg-neutral-primary">
    ...
    <div class="max-w-screen-xl px-4 py-3 mx-auto">
        <div class="flex items-center">
            <ul class="flex flex-col md:flex-row font-medium mt-0 space-y-2 md:space-y-0 space-x-0 md:space-x-8 rtl:space-x-reverse text-sm">
               ...
               @if (auth()->user()->role == 'admin')
                ...
                @if (auth()->user()->role === "tecnico")
                     <li>
                    <a href="{{ route('tecnico.actividades', auth()->user()->discipline_id) }}" class="text-heading hover:underline">Mis Actividades</a>
                </li>
                @endif
            </ul>
        </div>
