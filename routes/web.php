...
Route::middleware(['auth', CheckSup::class])->prefix('supervisor')->group(function () {
    ...
    Route::get('/stats/daily/pdf', [StatsController::class, 'supervisorDailyReportPdf'])->name('supervisor.stats.daily.pdf');
...
Route::middleware(['auth', CheckPlanAdmin::class])->prefix('admin')->group(function () {
    ...
    Route::get('/stats/daily/pdf', [StatsController::class, 'adminDailyReportPdf'])->name('admin.stats.daily.pdf');
